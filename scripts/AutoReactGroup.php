...
Class FacebookAutoReactGroup
{
	...
	{		
		...
		$logfilename = "feedgroup-{$this->groupid}-{$this->username}";
		$log_url = array();
	...
	{
		return file_put_contents("feedgroup-{$this->groupid}-{$this->username}", $datapost.PHP_EOL, FILE_APPEND);
	}
}
